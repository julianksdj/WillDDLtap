...
/**
*/
class WillDDLtapAudioProcessorEditor  : public juce::AudioProcessorEditor,
                                     public juce::Slider::Listener,
                                     public juce::Button::Listener
{
public:
    WillDDLtapAudioProcessorEditor (WillDDLtapAudioProcessor&);
    ~WillDDLtapAudioProcessorEditor() override;
    ...
    void sliderValueChanged (juce::Slider *slider) override
    {
        ...
        else if(slider == &tapSlider)
        {
            audioProcessor.setTaps(tapSlider.getValue()) ;
        }
...
private:
    ...
    WillDDLtapAudioProcessor& audioProcessor;
    bool buttonOn;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WillDDLtapAudioProcessorEditor)
};
