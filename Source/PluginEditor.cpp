...
//==============================================================================
WillDDLtapAudioProcessorEditor::WillDDLtapAudioProcessorEditor (WillDDLtapAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    addAndMakeVisible (tapSlider);
    tapSlider.setNormalisableRange(juce::NormalisableRange<double>(1.f, 10.f, 1.f,  1.f));
    tapSlider.addListener (this);
    tapSlider.setValue(audioProcessor.getTaps());
    tapLabel.setText ("Taps", juce::dontSendNotification);
    tapLabel.setJustificationType(juce::Justification::centred);
    tapLabel.setColour(juce::Label::textColourId, juce::Colours::white);
    addAndMakeVisible (tapLabel);
    tapSlider.setSliderStyle(juce::Slider::SliderStyle::LinearVertical);
    tapSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 80, 15);
...
WillDDLtapAudioProcessorEditor::~WillDDLtapAudioProcessorEditor()
{
}

//==============================================================================
void WillDDLtapAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void WillDDLtapAudioProcessorEditor::resized()
{
    ...
    tapSlider.setBounds(border+sliderWidth*2, border, sliderWidth-border, sliderHeight);
    wetLevelSlider.setBounds(border+sliderWidth*3, border, sliderWidth-border, sliderHeight);
    ...
    tapLabel.setBounds(border+sliderWidth*2, sliderHeight+15, sliderWidth-border, 20);
    wetLevelLabel.setBounds(border+sliderWidth*3, sliderHeight+15, sliderWidth-border, 20);
    
    crossButton.setBounds(border+sliderWidth*4, border+sliderHeight/3, 50,50);
}
